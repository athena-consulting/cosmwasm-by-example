...
const CONTRACT_NAME: &str = "crates.io:royality-721";
const CONTRACT_VERSION: &str = env!("CARGO_PKG_VERSION");

const MAX_DESCRIPTION_LENGTH: u32 = 512;

pub type Royality721Contract<'a> = cw721_base::Cw721Contract<'a, Empty, Empty>;
...
pub fn execute(
    ...
    Royality721Contract::default().execute(deps, env, info, msg)
}
...
pub fn query(deps: Deps, env: Env, msg: QueryMsg) -> StdResult<Binary> {
    match msg {
        ...
        _ => Royality721Contract::default().query(deps, env, msg.into()),
    }
}
