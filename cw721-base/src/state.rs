    ...
    T: Serialize + DeserializeOwned + Clone,
{
    ...
    pub base_ext: Item<'a, String>,
    pub pre_reveal_uri: Item<'a, String>,
    ...
    pub free_token_count: Item<'a, u64>,
}
    ...
    T: Serialize + DeserializeOwned + Clone,
{
    fn new(
        ...
        Self {
            ...
            // Extended initial values
            base_uri: Item::new("ipfs://QmRiLKmhizpnwqpHGeiJnL4G6fsPAxdEdCiDkuJpt7xHPH/"),
            base_ext: Item::new(".json"),
            pre_reveal_uri: Item::new("NOT_YET_REVEAL"),
            is_on_reveal: Item::new("false"),
        
            team: Item::new("terra10hcrj0tlum8nkk2apz3v6y0vrdd8k9murs9vfy"), // sweet_wallet
            pro: Item::new("terra109rgfl6x8v6k29dtfpc4kxq9tl08lly73wgjzg"),  // invoker_wallet
            treas: Item::new("terra1dsxpz56r8m3kga773a8f8754r7y7jqs95lda4k"),  // treas_wallet,
        
            free_token_count: Item::new("0"),
        }
    }
